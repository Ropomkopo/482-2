...
<!--BOF Product Series-->
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              <input type="text" name="product_description[<?php echo $language['language_id']; ?>][image_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['image_title'] : ''; ?>" placeholder="Image alt" id="input-image-title<?php echo $language['language_id']; ?>" class="form-control" />
        ...
        <script  type="text/javascript"><!--
          ...
          function seoPackageGen(field, lang) {
            $.ajax({
              url: 'index.php?route=module/complete_seo/get_value&type=product&id=<?php echo $_GET['product_id']; ?>&field='+field+'&lang='+lang+'&token=<?php echo $token; ?>',
              method: 'POST',
