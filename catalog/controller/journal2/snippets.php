            ...
            case 'product':
                ...
                if ($product_info) {
                    ...
                    if ((float)$product_info['special']) {
						$price = Journal2Utils::currencyFormat($this->tax->calculate($product_info['special'], $product_info['tax_class_id'], $this->config->get('config_tax')));
					} else {
						$price = Journal2Utils::currencyFormat($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')));
					}

					$this->journal2->settings->set('product_price', preg_replace('/[^0-9,\.,\,]/', '', $price));
