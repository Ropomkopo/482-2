...
<style>*::before, *::after {  box-sizing: border-box;}*:before, *:after {  box-sizing: border-box;}* {  box-sizing: border-box;}</style>
	...
	<form id="fastorder_data" enctype="multipart/form-data" method="post">
		...
		<div class="col-xsq-12 col-smq-6 col-mdq-6 col-lg-6">
...
<style>
		...
		<div class="well well-sm products" style="margin-top:10px;">
			<div class="product">
				<div class="row">
					<div class="col-xsq-12 text-center">
						<div class="product-name">
							<?php echo $heading_title; ?>
						</div>
					</div>
					<div class="col-xsq-6 text-center">
						<div class="quantity_quickorder quick-cell-one">
							<div class="quick-cell-content-one pquantity">
								<div class="input-group popup-quantity">
									<span class="input-group-btn-qucikorder">
					...
					<div class="col-xsq-6 text-center quick-cell-one">
...
<?php }?>						
		...
		<div class="form-group <?php echo $config_fields_firstname_requared == '1' ? 'sections_block_rquaired' : 'sections_block' ; ?>">
			<div class="input-group-quickorder margin-bottom-sm">			
				 <input id="contact-name" class="form-control contact-name input-quickorde" type="text" placeholder="<?php echo $config_placeholder_fields_firstname[$lang_id]['config_placeholder_fields_firstname']; ?>" value="" name="name_fastorder">		
				<span class="input-icon"><i class="icon-append-1 fa fa-user fa-fw"></i></span>
			</div>			
		</div>
		 <?php } ?>
		...
		<div class="form-group <?php echo $config_fields_phone_requared == '1' ? 'sections_block_rquaired' : 'sections_block' ; ?>">
			<div class="input-group-quickorder margin-bottom-sm">			
				 <input id="contact-phone" class="form-control contact-phone input-quickorde" type="text" placeholder="<?php echo $config_placeholder_fields_phone[$lang_id]['config_placeholder_fields_phone']; ?>" value="" name="phone">		
				<span class="input-icon"><i class="icon-append-1 fa fa-phone-square fa-fw"></i></span>
			</div>			
		</div>
		 <?php } ?>		 
		...
		<div class="input-group-quickorder margin-bottom-sm">                         
            <input id="contact-email" class="form-control contact-email input-quickorde" id="contact-email" type="text" placeholder="<?php echo $config_placeholder_fields_email[$lang_id]['config_placeholder_fields_email'];?>" value=""  name="email_buyer">
			<span class="input-icon"><i class="icon-append-1 fa fa-envelope fa-fw"></i></span>
		</div>
      </div>
	  <?php } ?>
	  ...
	  <?php if($on_off_fields_comment) { ?>
		...
		<div class="input-group-quickorder margin-bottom-sm">                          
            <input id="contact-comment" class="form-control contact-comment-buyer input-quickorde" name="comment_buyer" id="contact_comment_buyer"  placeholder="<?php echo $config_placeholder_fields_comment[$lang_id]['config_placeholder_fields_comment'];?>"/>
			<span class="input-icon"><i class="icon-append-1 fa fa-comment fa-fw"></i></span>	
		</div>
		</div>
		<?php } ?>
